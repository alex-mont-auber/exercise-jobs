...
public class Main {
	...
	public static void main(String[] args) throws Exception {
		...
		controller.createVolunteer("Juan Volunteer", "Dirección molona 4", "614266666", "First Volunteer");
		controller.createManagerEmployee("Pedro Manager Employee", "Dirección molona 2", "665226666", 80.0);
